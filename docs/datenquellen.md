...
| **Japan** | **Jap Carz** (jap-carz.com) | JSON-API der Website: `GET https://jap-carz.com/api/listings/?sort=upcoming_auctions&per_page=30&page=1` (Netzwerk-Tab 20.09.2026; Browser schickt ein Flask-`session`-Cookie mit, ob nötig ist offen) **[B]** | `npm run probe -- japcarz` zeigt Struktur und erstes Fahrzeug – Adapter folgt nach der Probe |

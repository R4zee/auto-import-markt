...
console.log(`✔ columns      ${bf.keyed} Inserate mit Bucket-Schlüssel · ${bf.pending} offen · ${bf.updated} mit Vergleichspreis aus ${bf.buckets} Buckets · ${Date.now() - tb} ms${bf.stopped ? `  ⚠ ${bf.stopped}` : ''}`);

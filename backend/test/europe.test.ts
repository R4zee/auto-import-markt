...
describe('Sauto.cz mapping', () => {
  ...
  it('bildet ein tschechisches Inserat als Festpreis in CZK im Markt Osteuropa ab', () => {
    ...
    // einziger vom CDN akzeptierter Parametersatz (Probe 21.09.2026); fremde Parameter werden ersetzt
    assert.equal(l.photos[0], 'https://d15-a.sdn.cz/d_15/c_img_QK_Iw/abc123.jpeg?fl=exf|res,1024,768,1|wrm,/watermark/sauto.png,10,10|jpg,80,,1');
    assert.equal(l.photos[1], 'https://d15-a.sdn.cz/d_15/c_img_QK_Iw/def456.jpeg?fl=exf|res,1024,768,1|wrm,/watermark/sauto.png,10,10|jpg,80,,1');
    assert.equal(l.partnerId, 'carpathia');
  });
